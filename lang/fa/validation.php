...
return [
    ...
    */
    ...
    "string"           => ":attribute باید به صورت رشته متنی باشد.",
    ...
    */
    'attributes' => [
        ...
        'description' => 'توضیحات',
        'geometry-location' => 'محدوده جغرافیایی',
        'leader-firstname' => 'نام آغازگر پویش',
        'leader-lastname' => 'نام خانوادگی آغازگر پویش',
        'leader-phone' => 'شماره تماس آغازگر پویش',
        'campain-name' => 'نام پویش',
        "name" => "نام",
        "username" => "نام کاربری",
